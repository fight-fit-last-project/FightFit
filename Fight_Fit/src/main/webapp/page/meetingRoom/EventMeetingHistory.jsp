            ...
            $.ajax({
                ...
                success: function (response) {
                    $.each(response, function (key, value) {
                        $('<option>').val(key.dropDownKey).text(value.dropDownValue).appendTo(meetingRoomID);
                    });
                }
            });
        });
    ...
    function doSearch() {
        ...
        table = $('#bookingTable').DataTable({
            ...
            columns: [
                ...
                {data: 'mobileNo', title: '<img style="width: 50px; height: 50px;" src="images/tel_image.png">'},
                {data: 'lineID', title: '<img style="width: 50px; height: 50px;" src="images/line_image.png">'}
