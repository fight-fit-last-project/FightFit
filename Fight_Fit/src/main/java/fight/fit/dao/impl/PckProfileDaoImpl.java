...
import fight.fit.dao.BaseDao;
import fight.fit.dao.PckProfileDao;
import fight.fit.domain.PckProfile;
import fight.fit.util.StringUtils;
import fight.fit.util.Utility;
...
public class PckProfileDaoImpl extends BaseDao implements PckProfileDao {
    ...
    final RowMapper<PckProfile> LIST_PCK_EMPLOYEE_ROW_MAPPER = new RowMapper<PckProfile>() {
